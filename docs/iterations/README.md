...
| v1.1.0 | Complete and stabilize the minimum safe Codex-to-Blueberry reaction loop | Technical MVP accepted; stabilization acceptance blocked by renderer-state mismatch | [v1.1.0 Codex Hooks](./v1.1.0-codex-hooks.md) |
