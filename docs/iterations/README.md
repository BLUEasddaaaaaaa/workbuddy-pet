...
| v1.1.0 | Complete and stabilize the minimum safe Codex-to-Blueberry reaction loop | Local macOS stabilization accepted; public binary distribution pending signing/notarization | [v1.1.0 Codex Hooks](./v1.1.0-codex-hooks.md) |
...
4. In scope
5. Out of scope
6. Product and technical decisions
7. Changes
8. Validation method
